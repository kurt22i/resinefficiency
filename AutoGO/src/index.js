        ...
        for (const f of await readdir("./good/", { withFileTypes: true }))
            if (f.isFile() && f.name.endsWith(".json")) {
                ...
                for (let i=0;i<5;i++) {//each artifact
                    const artitype = await page.$(`#simple-tabpanel-build > div > div:nth-child(6) > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-1.css-eujw0i > div:nth-child(${i+2}) > div > button > div > div.grad-5star.MuiBox-root.css-1fm09i6 > h6`)
                    ...
                    for (let j=0;j<4;j++) {//substats
                        const substat = await page.$(`#simple-tabpanel-build > div > div:nth-child(6) > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-1.css-eujw0i > div:nth-child(${i+2}) > div > button > div > div.MuiBox-root.css-11yya3r > div:nth-child(${j+1}) > span`)
